...
export const DEFAULT_KEYBINDS: KeybindConfig[] = [
    ...
    // Expand/collapse the overlay body (was click-only on the small pill
    // chip — a global shortcut means you don't need to precisely hit that
    // button to show/hide the panel).
    { id: 'general:toggle-expand', label: 'Expand / Collapse Overlay', accelerator: 'CommandOrControl+E', isGlobal: true, defaultAccelerator: 'CommandOrControl+E' },
